...
ALTER TABLE "tickets" ADD CONSTRAINT "tickets_verkocht_door_user_id_user_id_fk" FOREIGN KEY ("verkocht_door_user_id") REFERENCES "public"."user"("id") ON DELETE no action ON UPDATE no action;